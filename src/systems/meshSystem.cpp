...
namespace engine {
    MeshSystem::MeshSystem(Device& device, VkRenderPass renderPass, VkDescriptorSetLayout globalSetLayout): device{device} {
    ...
    //may have to reference the global UBO set
    //may just add assetSystem to frameInfo and keep using that.
    void MeshSystem::Render(VkCommandBuffer commandBuffer, VkDescriptorSet& globalUBOSet, ECS::AssetSystem& assets) {
