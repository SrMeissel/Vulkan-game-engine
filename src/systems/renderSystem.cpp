...
namespace engine {
    ...
    void RenderSystem::renderGameObjects(frameInfo& frameInfo) {
        ...
        for(auto& kv: frameInfo.gameObjects) {
            //If i want descriptors to be object specific, I need to set them up here?
            //I can create the pipeline above, and as long as it expects to correct sets I can bind them here.
