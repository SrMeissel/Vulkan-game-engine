...
namespace ECS {
    ...
    tinyxml2::XMLElement* Renderable::save(tinyxml2::XMLDocument& doc) {
        tinyxml2::XMLElement* renderable = doc.NewElement("Renderable");
        renderable->SetText(Path.c_str());
        return renderable;
    }

    tinyxml2::XMLElement* Material::save(tinyxml2::XMLDocument& doc) {
    ...
    tinyxml2::XMLElement* SkyBox::save(tinyxml2::XMLDocument& doc) {
    ...
    tinyxml2::XMLElement* PointLight::save(tinyxml2::XMLDocument& doc) {
    ...
    SpotLight::SpotLight(renderer::Device& device, Window& window, glm::vec3 color, float intensity, glm::vec2 resolution, VkRenderPass pass, VkSampler sampler, std::unique_ptr<renderer::DescriptorSetLayout>& setLayout) : 
    ...
    tinyxml2::XMLElement* SpotLight::save(tinyxml2::XMLDocument& doc) {
        return nullptr;
    }
    ...
    tinyxml2::XMLElement* Camera::save(tinyxml2::XMLDocument& doc) {
    ...
    Script::Script(const char* name, MonoAssembly* assembly, MonoDomain* appDomain) {
    ...
    tinyxml2::XMLElement* Script::save(tinyxml2::XMLDocument& doc) {
